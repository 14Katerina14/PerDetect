...
- manager: dashboard, alarm list/details, operations, people, maintenance, machine details and notifications;
- admin: overview, identity administration, employee details, system configuration and policy details.
