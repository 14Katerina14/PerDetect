...
namespace SecureZone.XProtectPlugin
{
    public class SecureZonePluginDefinition : PluginDefinition
    {
        ...
        public override void Init()
        {
            ...
            EnvironmentManager.Instance.Log(false, "SecureZone", "SecureZone decision bridge initialized.");
        }
        ...
        public override Guid SharedNodeId { get { return Guid.Empty; } }
        public override string Name { get { return "SecureZone"; } }
        public override string SharedNodeName { get { return "SecureZone"; } }
        public override string Manufacturer { get { return "SecureZone"; } }
        public override string VersionString { get { return "2.0.0.0"; } }
        public override Image Icon { get { return icon; } }
        public override UserControl GenerateUserControl() { return null; }
        public override bool UserControlFillEntirePanel { get { return false; } }
        public override List<BackgroundPlugin> BackgroundPlugins { get { return backgroundPlugins; } }
    }
}
